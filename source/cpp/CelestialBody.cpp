...
void CelestialBody2D::_bind_methods()
{
	...
	ADD_PROPERTY(godot::PropertyInfo(godot::Variant::FLOAT, "keplerian_true_anomaly", godot::PROPERTY_HINT_RANGE, "-360,360,0.1,or_less,or_greater,radians"), "set_true_anomaly", "get_true_anomaly");
...
{
    // Not working right now, see https://github.com/godotengine/godot/issues/71332
    /*
